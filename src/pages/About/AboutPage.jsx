...
/* Img */
import imgabout from '../../img/home.webp';
          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id='about-info-1'
                  defaultMessage="Бид Next.js, React, Node.js, MySQL, PostgreSQL зэрэг орчин үеийн технологи ашиглан хурдан, найдвартай, хэрэглэгчдэд ээлтэй системүүдийг хөгжүүлдэг. Мөн хэрэглэгчдийн шаардлагад нийцүүлэн захиалгат вэбсайт, QR кодын цэс, автомат тайлан, өгөгдлийн удирдлагын системүүдийг бүтээх туршлагатай."
                />
              </p>
              ...
              <div className="hide parrafo-active">
                <p>
                  <FormattedMessage
                    id='about-info-2'
                    defaultMessage='Хэрэглэгчиддээ чанар, хурд, аюулгүй байдал гурвыг зэрэг хангахыг зорьж, систем бүр дээрээ SSL, эрхийн хяналт, мэдээллийн хамгаалалтыг нэвтрүүлдэг. Бидний амжилттай хэрэгжүүлсэн төслүүдэд qr-uvs.mn, menu.uvs100.mn, eblank.mn, precilab.mn зэрэг системүүд багтдаг.'
                  />
                </p>
                ...
                <p>
                  <FormattedMessage
                    id='about-info-3'
                    defaultMessage="IT WORK бол таны найдвартай дижитал түнш. Бидэнтэй хамтран ажилласнаар та зөвхөн нэг вэб сайт бус, бизнесээ цахимжуулах цогц шийдлийг авах болно."
                  />
                </p>
              </div>
